...
Discourse::Application.routes.draw do
  ...
  get "users/:username/preferences/avatars" => "users#avatars", constraints: {username: USERNAME_ROUTE_FORMAT}
  put "users/:username/preferences/avatars/select" => "users#select_avatar", constraints: {username: USERNAME_ROUTE_FORMAT}
  post "users/:username/preferences/update_gravatar" => "users#update_gravatar", constraints: {username: USERNAME_ROUTE_FORMAT}
