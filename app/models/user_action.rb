...
SELECT
  ...
  pu.email, pu.username, pu.name, pu.id user_id, pu.avatar_template,
  u.email acting_email, u.username acting_username, u.name acting_name, u.id acting_user_id, u.avatar_template acting_avatar_template,
